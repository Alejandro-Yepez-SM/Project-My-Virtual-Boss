    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-blue-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <Badge
            className="mb-6 gradient-primary text-white border-0"
            variant="secondary"
          >
          ...
          <p className="text-xl text-neutral-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Transform your real estate career with daily schedules, CRM
            management, and goal tracking based on successful industry
            professionals' proven strategies.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              onClick={handleLogin}
              size="lg"
              className="gradient-primary text-white px-8 py-3 text-lg font-medium"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="px-8 py-3 text-lg border-2 border-primary text-primary hover:bg-primary hover:text-white"
            >
              Learn More
            </Button>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600">
              Built on proven strategies from top-performing real estate
              professionals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="card-hover border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-neutral-600 mb-4">
                  Predetermined daily activities with push notifications:
                </p>
                <ul className="space-y-2 text-sm text-neutral-600">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
                    50 FSBO cold calls daily
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
                    50 expired listing calls daily
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
            ...
            <Card className="card-hover border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-neutral-600 mb-4">
                  Complete contact management with categorization:
                </p>
                <ul className="space-y-2 text-sm text-neutral-600">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
                    Agent, Buyer, Seller tracking
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
                    FSBO, FRBO, Expired leads
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
            ...
            <Card className="card-hover border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-neutral-600 mb-4">
                  Essential real estate utilities:
                </p>
                <ul className="space-y-2 text-sm text-neutral-600">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-secondary mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-neutral-600">
                  1 out of every 10 past customers will give you a referral with
                  proper follow-up
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-neutral-600">
                  For every 200 people you contact, 1 becomes a customer within
                  3-6 months
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-neutral-600">
                  1 out of 25 renters can buy now, 2 out of 25 can buy next year
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-neutral-600">
                  5 out of 100 CRM contacts will become customers or refer
                  customers
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 mb-8">
            Join successful agents who use proven daily strategies to build
            their business
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              onClick={handleLogin}
              size="lg"
              className="gradient-primary text-white px-8 py-4 text-lg font-medium"
            >
              Start Your Success Journey Today
            </Button>
          </div>
          <p className="text-sm text-neutral-500 mt-4">
            No credit card required • Start building your success immediately
          </p>
        </div>
      </section>
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 bg-neutral-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-neutral-400 mb-4">
            Your Personal Real Estate Productivity Coach
          </p>
