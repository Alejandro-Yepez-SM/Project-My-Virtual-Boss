...
export default function Home() {
  ...
  /* useEffect(() => {
    if (
      tasks.length === 0 &&
      !autoInitializeMutation.isPending &&
      !hasInitialized
    ) {
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-neutral-600">
                      {t("dashboard.quarterlyProgress", "Q1 Progress")}
                    </p>
                    ...
                    <p className="text-xs text-secondary mt-1">
                      ...
                      {t("dashboard.onTrack", "On track for goals")}
                    </p>
                  </div>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-neutral-600">
                      {t("dashboard.thisQuarter", "This Quarter")}
                    </p>
                    {/*    <p className="text-2xl font-bold text-neutral-900">
                      $
                      {stats?.quarterlyIncome
                        ? Number(stats.quarterlyIncome).toLocaleString(
                            "en-US",
                            {
                    ...
                    {/*       <p className="text-xs text-secondary mt-1">
                      {t("common.goal", "Goal")}: $
                      {stats?.quarterlyGoal
                        ? Number(stats.quarterlyGoal).toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })
                        : "0.00"}
                ...
                <CardContent className="space-y-4">
                  {/*   {tasks.length === 0 ? (
                    <div className="text-center py-8 text-neutral-500">
                      ...
                      <p>
                        {t("dashboard.noTasks", "No tasks scheduled for today")}
                      </p>
                    </div>
                  ) : (
                    tasks.map((task) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    {t("dashboard.addContact", "Add New Contact")}
                  </Button>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      (window.location.href = "/crm?filter=follow-ups")
                    }
                  >
                    <Phone className="h-4 w-4 mr-2 text-secondary" />
                    {t("dashboard.viewFollowups", "View Follow-ups Due")}
                  </Button>
                  ...
                  >
                    ...
                    {t("dashboard.realEstateTools", "Real Estate Tools")}
                  </Button>
                  ...
                  >
                    ...
                    {t("dashboard.viewGoals", "View Goals & Progress")}
                  </Button>
                </CardContent>
              </Card>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-neutral-600">
                      ...
                      {/*   <span className="font-medium text-neutral-900">
                        $
                        {stats?.quarterlyGoal
                          ? Number(stats.quarterlyGoal).toLocaleString(
                              "en-US",
                              {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                    ...
                    <div className="bg-neutral-50 rounded-lg p-3 mt-4">
                      ...
                      <div className="text-xs">
                        <span className="font-medium text-neutral-900">
                          $
                          {(
                            Number(stats.quarterlyGoal) -
                            Number(stats.quarterlyIncome)
