...
export default function Goals() {
  ...
  // Fetch contacts to calculate follow-ups target
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">
                      Set Up Your Income Goals
                    </h3>
                    <p className="text-gray-600 mt-2">
                      Get started by setting up your quarterly income targets
                      for sales, rentals, and other income.
                    </p>
                  </div>
                  <Button
                  ...
                  >
                    <Plus className="h-4 w-4 mr-2" />
                    ssd
                    {initializeGoalsMutation.isPending
                      ? "Setting Up..."
                      : "Set Up Income Goals"}
                  </Button>
                </div>
          ...
          {/*  {Array.isArray(goals) && goals.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {incomeGoalTypes.map((goalType) => {
                  ...
                  const activeGoals = typeGoals.filter(
                    (g: any) => !g.isCompleted
                  );
                  ...
                  const totalCurrent = activeGoals.reduce(
                    (sum: number, g: any) => sum + (g.currentValue || 0),
                    0
                  );
                  ...
                  return (
                    <Card
                      key={goalType.value}
                      className={`${goalType.bgColor} ${goalType.borderColor} border`}
                    >
          ...
          {/* Show activity goals in summary format */}
          {/* {Array.isArray(goals) && goals.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="md:col-span-3">
                  <h3 className="text-lg font-semibold mb-4">
                    Activity Goals Summary
                  </h3>
                </div>

                <Card className="bg-teal-50 dark:bg-teal-900/20 border-teal-200 dark:border-teal-800 border">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">
                          Target Based on Contacts
                        </span>
                        <span className="text-sm font-medium text-teal-600">
                          {(contacts as any[]).length} × 2
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-gray-600">
                          Target:{" "}
                          <span className="font-medium">
                            {(contacts as any[]).length * 2} follow-ups
                          </span>
                        </span>
                      </div>

                      <div className="text-xs text-gray-500 mt-2">
                        Follow-up target automatically updates when you add
                        contacts
                      </div>
                    </div>
                  </CardContent>
          ...
          {/*   <TabsContent value="active" className="space-y-6">
            ...
            {Array.isArray(goals) && goals.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-3">
                  <h3 className="text-lg font-semibold mb-4">Activity Goals</h3>
                </div>
          ...
          <TabsContent value="completed" className="space-y-6">
            {/*    <div className="grid gap-4">
              {(goals as any[])
                .filter((goal: any) => goal.isCompleted)
                .map((goal: any) => {
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {(goals as any[]).filter((g: any) => !g.isCompleted).length}
                  </div>
                </CardContent>
              </Card>
