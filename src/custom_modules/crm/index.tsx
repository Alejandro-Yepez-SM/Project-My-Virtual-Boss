 ...
 */
  ...
  /* const callContactMutation = useMutatio({
    ...
    onSuccess: (newContact) => {
      ...
      setTimeout(() => {
        toast({
          ...
          description: `Send your virtual business card to ${
            newContact.firstName || "the new contact"
          } via text message to make a great first impression!`,
          duration: 8000,
        });
      }, 2000);
      ...
      setTimeout(() => {
        toast({
          ...
          description: `Follow-up with ${
            newContact.firstName || "this contact"
          } has been scheduled for tomorrow. Check your follow-ups tab!`,
          duration: 6000,
        });
      }, 4000);
    },
  ...
  /* const filteredContacts = contacts.filter((contact) => {
    ...
    const matchesTab =
      ...
      (activeTab === "follow-ups" &&
        followUps.some((f) => f.id === contact.id)) ||
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-neutral-900">
                    {/*  {
                      contacts.filter((c) => c.leadScore >= 80 && c.isActive)
                        .length
                    } */}
                  </p>
                </div>
                  ...
                  <p className="text-2xl font-bold text-neutral-900">
                    {/*  {
                      contacts.filter((c) => {
                        ...
                        return (
                          contactDate.getMonth() === thisMonth.getMonth() &&
                            ...
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <div className="flex items-center space-x-1">
                                  <Star
                                    className={`h-4 w-4 ${getLeadScoreColor(
                                      contact.leadScore
                                    )}`}
                                  />
                                  <span
                                    className={`text-sm font-medium ${getLeadScoreColor(
                                      contact.leadScore
                                    )}`}
                                  >
                                    {contact.leadScore}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewContact((prev) => ({ ...prev, source: value }))
                    }
                  >
                    <SelectTrigger>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <Button
                  onClick={() => {
                    if (
                      !editingContact.firstName.trim() ||
                      !editingContact.lastName.trim()
                    ) {
                      toast({
                        title: "Validation Error",
                        description: "First name and last name are required.",
