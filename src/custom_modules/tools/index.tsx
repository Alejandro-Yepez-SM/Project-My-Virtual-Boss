...
import ExpiredListingsCalculator from "./components/ExpiredListingsCalculator";
import OwnerInformationCalculator from "./components/OwnerInformationCalculator";
  ...
  const availableTools = [
    {
      ...
      description:
        "Comprehensive rental property analysis with unit-by-unit breakdown, DSCR calculations, and future projections",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Calculate monthly mortgage payments with detailed breakdown of principal, interest, taxes, insurance, PMI, and HOA fees",
      icon: Calculator,
    ...
    },
    {
      ...
      description:
        "Help clients understand their buying power and monthly payment options with detailed mortgage calculations",
      icon: Home,
    ...
    },
    {
      ...
      description:
        "Calculate estimated net proceeds from sale using location-specific closing costs and fees",
      icon: DollarSign,
    ...
    },
    {
      ...
      description:
        "Generate comparative market analysis using multiple data sources for rough property valuations",
      icon: BarChart3,
    ...
    },
    {
      ...
      description:
        "Find expired MLS listings with complete property details and skip trace owner information",
      icon: Clock,
    ...
    },
    {
      ...
      description:
        "Get detailed contact information for owners of abandoned houses, vacant properties, and FSBO listings",
      icon: Users,
      color: "bg-indigo-50 border-indigo-200",
      iconColor: "text-indigo-600",
      badge: "Contact Research",
        ...
        <div className="space-y-6">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              {activeTool === "prequalification" && (
                <PrequalificationCalculator />
              )}
              {activeTool === "netsheet" && <SellerNetSheetCalculator />}
              {activeTool === "cma" && <CMACalculator />}
              {activeTool === "expired-listings" && (
                <ExpiredListingsCalculator />
              )}
              {activeTool === "owner-information" && (
                <OwnerInformationCalculator />
              )}
            </CardContent>
          </Card>
        </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-white/90 text-lg">
                Professional calculators and analysis tools to grow your
                business
              </p>
            </div>
          </div>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`w-12 h-12 ${tool.color.replace(
                        "50",
                        "100"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {comingSoonTools.map((tool, index) => (
              <Card key={index} className={`${tool.color} border-2 opacity-75`}>
                <CardContent className="p-4">
                  <div
                    className={`w-10 h-10 ${tool.color.replace(
                      "50",
                      "100"
